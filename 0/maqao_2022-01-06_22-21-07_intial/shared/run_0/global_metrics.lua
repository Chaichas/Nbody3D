_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 5.3333,
    ...
    number_processes = 1,
    speedup_if_FP_only = 1.1111,
    nb_threads = 1,
    application_time = 8.26,
  ...
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 8.26 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 8.26 seconds.",
  },
  colors = {
