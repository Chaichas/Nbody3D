_report = {
  metrics = {
    ...
    loops_time = 93.02,
    speedup_if_fp_vect = 1.0031,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0750376263169,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0526315789474,
    ...
    speedup_if_fully_vectorised = 1.0035,
    ...
    number_processes = 1,
    speedup_if_FP_only = 1.0005,
    nb_threads = 8,
    application_time = 0.62,
    compilation_options = "Not Available",
    innerloops_time = 92.6,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 0.576724 seconds.",
    ...
    profiled_time = "Application profiling duration in seconds<br><b>Too short run</b>: statistical accuracy of profiling results is average (profiled time corresponds to 960 samples)<br><b>Workaround</b>: Rerun with a longer workload and/or use sampling-rate=high/highest in lprof_params",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 0.57412 seconds.",
  },
  colors = {
